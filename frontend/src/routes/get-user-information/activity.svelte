...
<template>
	<section class="container z-20 bg-primary-focus py-4 drop-shadow-md">
		<div class=" flex h-full w-full  items-center space-x-2">
			...
			<h1 class="w-max text-xl font-bold text-primary-content">My Activity</h1>
		</div>
	</section>
	<div class="container h-screen w-screen bg-gradient-to-t from-primary to-primary-focus">
		<main class="flex flex-col items-center justify-center pt-24">
			...
			<div class="mt-12 flex w-full flex-col items-center justify-center space-y-6">
				...
				>
					<p class="text-lg font-semibold text-primary-focus">Sedentary</p>
				...
				<button
					...
					class="w-full rounded-3xl bg-primary-content p-4 drop-shadow-lg"
				>
					<p class="text-lg font-semibold text-primary-focus">Lightly Active</p>
				...
				<button
					...
					class="w-full rounded-3xl bg-primary-content p-4 drop-shadow-lg"
				>
					<p class="text-lg font-semibold text-primary-focus">Moderately Active</p>
				...
				<button
					...
					class="w-full rounded-3xl bg-primary-content p-4 drop-shadow-lg"
				>
					<p class="text-lg font-semibold text-primary-focus">Active</p>
				...
				<button
					...
					class="w-full rounded-3xl bg-primary-content p-4 drop-shadow-lg"
				>
					<p class="text-lg font-semibold text-primary-focus">Very Active</p>
